...
struct UserTests {
    ...
    private func getUsers() throws -> [User] {
        let users = [
            try User(email: "richieflores@gmail.com", firstName: "Richie", lastName: "Flores", username: "cstitans22"),
            try User(email: "bryanjsample@yahoo.com", firstName: "Bryan", lastName: "Sample", username: "bsizzle", pictureUrl: nil),
            try User(email: "richie.flores@bemidjistate.edu", firstName: "Richie", lastName: "Flores", username: "cstitans22", pictureUrl: "https://lh3.googleusercontent.com/a-/AOh14GiAbCdEf"),
            try User(email: "marie.curie@example.com", firstName: "Marie", lastName: "Curie", username: nil, pictureUrl: "https://cdn.example.com/users/mcurie/avatar.png"),
            try User(email: "chloe.martin@gmail.com", firstName: "Chloë", lastName: "Martin", username: "chloem", pictureUrl: nil),
            try User(email: "angelo.rossi@example.org", firstName: "D’Angelo", lastName: "Rossi", username: "angelor", pictureUrl: "https://lh3.googleusercontent.com/ogw/AAELabc123"),
            try User(email: "anne-marie@domain.co", firstName: "Anne-Marie", lastName: "Dupont", username: nil, pictureUrl: nil),
            try User(email: "jose.alvarez@example.net", firstName: "José", lastName: "Álvarez", username: "jalvarez", pictureUrl: "https://static.domain.io/profiles/u_44/photo.jpg"),
            try User(email: "luc.benoit@example.com", firstName: "Luc", lastName: "Benoît", username: nil, pictureUrl: nil),
            try User(email: "francois.dupont@example.com", firstName: "François", lastName: "Dupont", username: "fdupont", pictureUrl: nil),
            try User(email: "john.doe@gmail.com", firstName: "John", lastName: "Doe", username: nil, pictureUrl: nil),
            try User(email: "jane.smith@hotmail.com", firstName: "Jane", lastName: "Smith", username: "jsmith", pictureUrl: nil),
            try User(email: "sofia.garcia@example.io", firstName: "Sofía", lastName: "García", username: nil, pictureUrl: "https://lh3.googleusercontent.com/p/AF1QipPp9d0YxL1?sz=256"),
            try User(email: "liam.brown@example.org", firstName: "Liam", lastName: "Brown", username: "liamb", pictureUrl: nil),
            try User(email: "emma.wilson@example.com", firstName: "Emma", lastName: "Wilson", username: nil, pictureUrl: nil),
            try User(email: "noah.johnson@example.net", firstName: "Noah", lastName: "Johnson", username: "noahj", pictureUrl: "https://sub.domain.com/path/to/img/profile.svg"),
            try User(email: "olivia.thompson@example.com", firstName: "Olivia", lastName: "Thompson", username: nil, pictureUrl: nil),
            try User(email: "james.anderson@example.org", firstName: "James", lastName: "Anderson", username: "janderson", pictureUrl: "https://images.site.net/pfps/user123.webp"),
            try User(email: "mia.rodriguez@example.com", firstName: "Mía", lastName: "Rodríguez", username: nil, pictureUrl: nil),
            try User(email: "ethan.miller@example.io", firstName: "Ethan", lastName: "Miller", username: "ethanm", pictureUrl: nil),
            try User(email: "ava.martinez@example.com", firstName: "Ava", lastName: "Martínez", username: nil, pictureUrl: nil),
        ]
        return users
    }
